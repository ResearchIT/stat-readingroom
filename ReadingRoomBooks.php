...
<title>Reading Room Books</title>
<link rel="stylesheet" media="all" href="/_common/phpMySqlEdit.css"/>
<style type="text/css"></style>
</head>
<body>
<h3>Reading Room Books</h3>
<?php
...
$opts['hn'] = getenv('DB_HOST');
$opts['un'] = getenv('DB_USER');
$opts['pw'] = getenv('DB_PASS');
$opts['db'] = getenv('DB_NAME');
$opts['tb'] = 'ReadingRoomBooks';
...
$opts['fdd']['Borrower']['sort'] = 'name';
$opts['fdd']['Borrower']['values']['table']   = 'Statdir';
...
// $opts['fdd']['ContactedID']['values']['table']   = 'Statdir';
// $opts['fdd']['ContactedID']['values']['column']   = 'netid';
...
require_once $_SERVER['DOCUMENT_ROOT'].'/_common/phpMyEdit.class.fancy.AddOnly.php';
new phpMyEdit($opts);
